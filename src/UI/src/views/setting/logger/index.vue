<template>
	<el-container>
		<el-aside width="220px">
			<el-tree ref="category" @node-click="categoryClick" class="menu" node-key="label" :data="category"
				...
				<el-container>
					<el-header>
						<div class="left-panel">
							<el-date-picker v-model="date" @change="handlePick" type="datetimerange" range-separator="至"
					...
					<el-main class="nopadding">
						<scTable ref="table" :data="dataList" :page-size="pageSize"
							@pagination-change="handlePaginationChange" @pagesize="pageSizeChange" stripe
							highlightCurrentRow @row-click="rowClick">
							<el-table-column label="级别" prop="level" width="50">
								<template #default="scope">
									<el-icon v-if="scope.row.level == 'Fatal'"
										style="color: #F56C6C;"><el-icon-circle-close-filled /></el-icon>
									<el-icon v-if="scope.row.level == 'Critical'"
										style="color: #F56C6C;"><el-icon-circle-close-filled /></el-icon>
							...
							<el-table-column label="日志名" prop="LoggerName" width="200"></el-table-column>
