...
namespace Application.Features.Notifications.Caching;

public static class NotificationCacheKey
{
    public const string GetAllCacheKey = "all-Notifications";
    ...
    {
        return $"NotificationsWithPaginationQuery,{parameters}";
    }
