...
namespace Application.Features.ScheduledJobs.Caching;

public static class ScheduledJobCacheKey
{
    public const string GetAllCacheKey = "all-ScheduledJobs";
    ...
    {
        return $"ScheduledJobsWithPaginationQuery,{parameters}";
    }
