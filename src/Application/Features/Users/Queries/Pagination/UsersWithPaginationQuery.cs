...
/// 用户分页查询
/// </summary>
public class UsersWithPaginationQuery : UserAdvancedFilter, IRequest<PaginatedData<UserDto>>
{
...
IRequestHandler<UsersWithPaginationQuery, PaginatedData<UserDto>>
{
    ...
    public async Task<PaginatedData<UserDto>> Handle(UsersWithPaginationQuery request,
